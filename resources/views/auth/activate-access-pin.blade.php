        ...
        <div class="authentication-inner py-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="formAuthentication" class="mb-2" action="{{ route('auth.access-pin') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-3">
                                <input type="password" class="form-control single_number"
                                    id="confirm_access_pin" name="confirm_access_pin[0]" />
                                <input type="password" class="form-control single_number"
                                    name="confirm_access_pin[1]" />
                                <input type="password" class="form-control single_number"
                                    name="confirm_access_pin[2]" />
                                <input type="password" class="form-control single_number"
                                    name="confirm_access_pin[3]" />
                                <input type="password" class="form-control single_number"
                                    name="confirm_access_pin[4]" />
                                <input type="password" class="form-control single_number"
                                    name="confirm_access_pin[5]" />
                            </div>
                        </div>
                        @error('*')
                        ...
                        @enderror
                        <button class="btn btn-primary d-grid w-100">Activate</button>
                    </form>
                </div>
            </div>
        </div>
