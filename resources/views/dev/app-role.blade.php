...
@section('content')
            ...
            <div class="card">
                <div class="card-header d-flex align-middle">
                    ...
                    <div class="col-6 text-end">
                        <button class="btn btn-success" id="add-app-role" data-bs-toggle="modal"
                            data-bs-target="#modal-app-role">Add <i class='bx bxs-file-plus pb-1'></i></button>
                    </div>
                </div>
                <div class="card-body">
    ...
    <div class="modal fade" id="modal-app-role" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
