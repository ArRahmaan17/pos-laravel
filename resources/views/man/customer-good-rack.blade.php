...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="alert alert-warning">Please Select Your Company</div>
