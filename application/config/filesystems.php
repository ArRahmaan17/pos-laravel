...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'temp-customer-product' => [
            'driver' => 'local',
            'root' => public_path('temp-customer-product'),
            'url' => env('APP_URL').'/temp-customer-product',
            'visibility' => 'public',
            'throw' => false,
        ],
        'public' => [
        ...
        'default' => [
            'driver' => 'local',
            'root' => public_path('resources/default'),
            'url' => env('APP_URL').'resources/default',
            'visibility' => 'public',
            'throw' => false,
        ],
