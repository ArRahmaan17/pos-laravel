...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('company.user', compact('users', 'customer_roles'));
    }
    ...
    public function generateRegistrationLink(Request $request)
    {
        ...
        $request->validate([
            'managerIdLink' => 'required',
            'roleIdLink' => 'required',
        ], [
            'managerIdLink.required' => 'The user field is required',
            'roleIdLink.required' => 'The user role field is required',
        ]);
        if (getScope() === 'global') {
            $id = $request->managerIdLink;
        } else {
            $id = session('userLogged')['user']['id'];
        }
        $role = $request->roleIdLink;
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            UserRole::create(['user_id' => $user->id, 'role_id' => $request->role_id, 'company_id' => session('userLogged')['company']['id']]);
