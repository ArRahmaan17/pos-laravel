...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $user = User::where('username', $request->username)->orWhere('email', $request->username)->orWhere('phone_number', $request->username)->first();
        ...
        if (!empty($user) && Hash::check($request->password, $user->password)) {
            ...
            // dd($role['role']['name']); // Tambahkan ini sebelum if untuk mengecek nilai sebenarnya
        ...
        return redirect()->back()->with('error', "Your provide <i><b>Username/Email/Phone Number</b></i> or <i><b>Password</b></i> dons't match to our record")->withInput();
    }
